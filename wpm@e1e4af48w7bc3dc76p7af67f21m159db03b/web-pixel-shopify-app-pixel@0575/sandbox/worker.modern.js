(() => {
    var e = {
            856: function(e, t, r) {
                ...
                ! function(a, s) {
                    "use strict";
                    n = [r(652)], void 0 === (o = "function" == typeof(i = function(e) {
                        var t = /(^|@)\S+:\d+/,
                            r = /^\s*at .*(\S+:\d+|\(native\))/m,
                            i = /^(eval@)?(\[native code])?$/;
                        return {
                    ...
                    var a = "function",
                        ...
                        J = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                ...
                                var e = {};
                                return e[b] = o, e[m] = o, X.call(e, i, y.os), x && !e[b] && g && "Unknown" != g.platform && (e[b] = g.platform.replace(/chrome os/i, _).replace(/macos/i, V)), e
    ...
    r.amdO = {}, r.n = e => {
        ...
        const p = "production",
            m = "0.0.451",
            w = "e1e4af48w7bc3dc76p7af67f21m159db03b",
            g = "se1e4af48w7bc3dc76p7af67f21m159db03bm.js";
        var h = r(856),
            v = r.n(h);
        ...
        function N(e) {
            const t = e.trim(),
                r = t.indexOf("=");
            return -1 === r ? [t, void 0] : [t.slice(0, r), t.slice(r + 1)]
        }
        ...
        function C(e) {
                    ...
                    set: function(t) {
                        ...
                        if (!(r.filter((e => new RegExp(`^\\.?${e}$`).test(o))).length > 0)) {
                            ...
                            i.update((() => e.browser.cookie.set(t)), (() => function(e, t) {
                                const [r = ""] = t.split(";"), [i, n] = N(r);
                                if (!i) return e;
                                const o = e.split(";").reduce(((e, t) => {
                                    const [r, i] = N(t);
                                    return r && (e[r] = i), e
                                }), {});
                                return o[i] = n, Object.keys(o).map((e => void 0 === o[e] ? e : `${e}=${o[e]}`)).join("; ")
                            }(r, t)))
                        }
                    },
                    configurable: !1,
            ...
            function({
                ...
                const r = T(t, e.browser.localStorage);
            ...
            function({
                ...
                const r = T(t, e.browser.sessionStorage);
        ...
        const L = new URL(self.location.href);
        ...
        function B(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol) throw new I(`URL must be secure (HTTPS): ${t.href}`);
            const r = L.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^https://(.*@)?${r}`, "i").test(t.href)) throw new M(`Request are not allowed to the same origin: ${t.href}`);
            return t
        }
        ...
        function P() {
            ...
            return XMLHttpRequest.prototype.open = function(t, r, i = !0, n, o) {
                return e.call(this, t, B(r), i, n, o)
            }, XMLHttpRequest
        }
        const U = {
                Request: !1,
        ...
        function D(e, t) {
            ...
            do {
                Object.getOwnPropertyNames(r).filter((e => e in t && !1 !== t[e])).forEach((e => {
                    try {
                        let i;
                        "object" == typeof t[e] ? (i = r[e], D(i, t[e])) : i = !0 === t[e] ? void 0 : t[e], E(r, e, {
                            value: i,
                            configurable: !1,
                            enumerable: !1,
                            writable: !1
        ...
        function q(e, t = self) {
            ...
            }(t.addEventListener)), D(t, r), Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), Object.freeze(RegExp.prototype), E(self, "String", {
                writable: !1,
                configurable: !1
            }), E(self, "Request", {
                writable: !1,
        ...
        Object.defineProperty(self, "webPixelsManager", {
            value: {
                createShopifyExtend: () => ({
                    extend: async (e, t) => {
                        if ("WebPixel::Render" !== e) throw new F;
                        V = t
                    }
                })
            },
        ...
        const z = async e => {
            ...
            if ($) {
                ...
                throw O(e, {
                    ...
                    sandboxUrl: L.href || "unknown"
                }), e
            }
            $ = !0, a(o), a(s);
            try {
                _ && (o.browser.sendBeacon = R), _ || (C(e), self.document.title = r)
            } catch (l) {
                throw O(l, {
                    pixelId: i.id,
                    pixelType: i.type,
            ...
            return await (null == (t = V) ? void 0 : t.call(o, o)), {
                status: "success",
                hashVersion: w,
                sandboxUrl: L.href || "unknown"
            }
