! function() {
    var e = {
            ...
            3249: function(e, t, n) {
                ...
                t.updateTrackingConsent = function(e, t) {
                    ...
                    n.open("POST", "/set_tracking_consent.json", !0), n.setRequestHeader("Content-Type", "application/json"), n.onreadystatechange = function() {
                        ...
                        var a;
                        0 === (a = n.status) || 200 >= a && a < 400 ? (r.dispatchEvents(e), t(null, i)) : t(i)
                    }, n.send(i)
                }
            },
            7560: function(e, t, n) {
            ...
            5841: function(e, t, n) {
                ...
                }, t.getCMPConsentValues = u, t.getRegulationValue = function() {
                    const e = c();
            ...
            8920: function(e, t, n) {
                ...
                function g() {
                    return !1 === _() ? r.DisplayConsentValues.DECLINED : (e = i.getCCPAConsentValue(), i.validCookieDoesNotExist() ? r.DisplayConsentValues.NO_VALUE : e === r.ConsentValues.NO_VALUE ? r.DisplayConsentValues.NO_INTERACTION : i.transformConsentToDisplaySchema(e));
                    var e
                }
                t.saleOfDataRegion = a.saleOfDataRegion, t.GPCSignal = _, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                }, t.getCCPAConsent = g, t.getLandingPageData = p, t.getRegulation = function() {
                    ...
                    return console.warn("shouldShowCCPABanner is deprecated and will be removed."), a.saleOfDataRegion() && g() === r.DisplayConsentValues.NO_INTERACTION
            ...
            1449: function(e, t) {
                ...
                t.readCookie = function(e, t = null) {
                    return e in n || function(e) {
                        const t = document.cookie ? document.cookie.split("; ") : [];
                        n[e] = void 0;
                        for (let o = 0; o < t.length; o++) {
                            const [r, i] = t[o].split("=");
                            if (e === decodeURIComponent(r)) return n[e] = JSON.parse(decodeURIComponent(i)), n[e]
                        }
                    }(e) || function(e, t) {
                        if (null === t) return;
                        n[e] = void 0;
                        let o, r, i = document.head.querySelector(`meta[name=${t}]`);
                        if (i instanceof HTMLMetaElement) {
                            o = i.content;
                            try {
                                const e = o.replace(/1/g, "true").replace(/0/g, "false").split(";").map((e => e.trim())).map((e => e.split("=").map((e => e.trim()))));
                                if (r = Object.fromEntries(e), r.purposes) {
                                    const e = r.purposes.split(/(true|false)/).filter(Boolean),
                                        t = {};
                                    for (let n = 0; n < e.length; n += 2) t[e[n]] = JSON.parse(e[n + 1]);
                                    r.purposes = t
                                }
                                for (let [e, t] of Object.entries(r)) "true" === t && (r[e] = !0), "false" === t && (r[e] = !1)
                            } catch (e) {
                                return
                            }
                            n[e] = r
                    ...
                    if (!o(i)) throw new TypeError("Cookie value is not correctly URI encoded.");
                    if (!o(e)) throw new TypeError("Cookie name is not correctly URI encoded.");
                    let a = `${e}=${i}`;
                    a += "; path=/", a += `; domain=${t}`, a += `; expires=${new Date((new Date).getTime()+r).toUTCString()}`, a += "; secure", document.cookie = a, n[e] = JSON.parse(decodeURIComponent(i))
                }
            },
            5814: function(e, t, n) {
                "use strict";
            ...
            7385: function(e, t, n) {
                ...
                var d = function(e) {
                    ...
                    return r(n, e), n.prototype.initialize = function(e) {
            ...
            372: function(e, t) {
                ...
                var o = function() {
                    function e(e, t) {
                        this.options = {}, this.initialized = !1, this.options = n(n({}, e), t)
                    }
                ...
                var a = n(7385),
                    ...
                    l = function(e) {
                        function t(n, o) {
                            ...
                            return r.campaignManager = new p.CampaignManager, r
                        }
                        return r(t, e), t.prototype.integrationPurposes = function() {
                            return [d.ConsentPurposes.THIRD_PARTY_MARKETING]
                        }, t.prototype.consentCollected = function(e) {}, t.prototype.name = function() {
                            ...
                            for (var n = this.options, o = 0, r = this.getFacebookPixelIds(n); o < r.length; o++) {
                                var i = r[o];
                                c.userDataCannotBeSold() && this.setLimitedDataUseMode(), window.fbq("init", i), "" !== n.agent && window.fbq("set", "agent", n.agent, i)
                            }
            ...
            7575: function(e, t, n) {
                ...
                var a = n(7385),
                    ...
                    l = function(e) {
                        ...
                        return r(t, e), t.prototype.identify = function(e) {
                        ...
                        }, t.prototype.consentCollected = function(e) {
                            if (d.default.isEnabled(d.TREKKIE_GOOGLE_CONSENT_MODE)) {
                                var t = e.analyticsAllowed,
                                ...
                                }), t ? delete window["ga-disable-" + this.options.trackingId] : window["ga-disable-" + this.options.trackingId] = !0
                            }
                            ...
                            var o = this.options;
                            "localhost" === s.hostname() && (o.domain = "none"), o.enhancedEcommerce && this.enhancedEcommerce(), d.default.isEnabled(d.TREKKIE_GOOGLE_CONSENT_MODE) && window.gtag("consent", "default", {
                            ...
                            }), window.ga("create", o.trackingId, {
                                cookieDomain: o.domain || t.defaultOptions.domain,
                                siteSpeedSampleRate: o.siteSpeedSampleRate,
                                sampleRate: o.sampleRate,
                                allowLinker: !0
                            }), o.doubleClick && window.ga("require", "displayfeatures"), o.enhancedLinkAttribution && window.ga("require", "linkid"), o.anonymizeIp && window.ga("set", "anonymizeIp", !0), e.prototype.initialize.call(this, n)
                        }, t.prototype.setPixelStub = function() {
                            (!window.ga || window.ga && "function" != typeof window.ga) && (window.ga = function() {
                                (window.ga.q = window.ga.q || []).push(arguments)
                            }), d.default.isEnabled(d.TREKKIE_GOOGLE_CONSENT_MODE) && (!window.gtag || window.gtag && "function" != typeof window.gtag) && (window.dataLayer = window.dataLayer || [], window.gtag = function() {
                ...
                var i = n(7385),
                    ...
                    p = function(e) {
                        ...
                        return r(t, e), t.prototype.integrationPurposes = function() {
                            ...
                            if (u.default.isEnabled(u.TREKKIE_GOOGLE_CONSENT_MODE)) {
                                var t = e.analyticsAllowed,
                                    n = e.marketingAllowed;
                                window.gtag("consent", "update", {
                                    ad_storage: n ? "granted" : "denied",
                            ...
                            throw new Error("identify is not supported")
                        }, t.prototype.track = function(e) {}, t.prototype.initialize = function(t) {
                            var n = this.options,
                                o = {
                                    send_page_view: !1
                                };
                            this.setPixelStub(), this.loadGtagScript(), s.userDataCannotBeSold() && (o.restricted_data_processing = !0), u.default.isEnabled(u.TREKKIE_GOOGLE_CONSENT_MODE) && window.gtag("consent", "default", {
                                ...
                                analytics_storage: d.analyticsProcessingAllowed() ? "granted" : "denied"
                            }), n.ignoreReferrer && (window.gtag("set", {
                                ignore_referrer: "true"
                            }), o.ignore_referrer = "true"), window.gtag("config", n.conversionId, o), e.prototype.initialize.call(this, t)
                        }, t.prototype.setPixelStub = function() {
                ...
                var a = n(7385),
                    ...
                    u = function(e) {
                        ...
                        return r(t, e), t.prototype.identify = function(e) {}, t.prototype.track = function(e) {}, t.prototype.page = function(e) {
                            ...
                            var n = this.options;
                            this.setPixelStub(), this.loadPinterestScript(), window.pintrk("load", n.pixelId, {
                                np: "shopify"
                            }), window.pintrk("page"), e.prototype.initialize.call(this, t)
                        }, t.prototype.setPixelStub = function() {
            ...
            3653: function(e, t, n) {
                ...
                var v = function(e) {
                    ...
                    return r(n, e), n.prototype.integrationPurposes = function() {
                        return []
                    }, n.prototype.consentCollected = function(e) {}, n.prototype.name = function() {
                        return "S2S"
                        ...
                        return i(i({}, t), {
                            ...
                            asset_version_id: "64022fdadec5c8ec4be5f67dbeb0521916405ce3",
            ...
            2724: function(e, t, n) {
                ...
                var d = function(e) {
                    ...
                    return r(n, e), n.prototype.integrationPurposes = function() {
                        ...
                        this.timestampManager = new p, this.campaignManager = new l, this.initialized = !0, e()
                ...
                var a = n(7385),
                    ...
                    d = function(e) {
                        ...
                        return r(t, e), t.prototype.integrationPurposes = function() {
                            ...
                            var n = this.options;
                            window.snaptr("init", n.pixelId), e.prototype.initialize.call(this, t)
                        }, t.prototype.setPixelStub = function() {
                ...
                var i = n(7385),
                    ...
                    u = function(e) {
                        ...
                        return r(t, e), t.prototype.integrationPurposes = function() {
                            ...
                            var n = this.options;
                            this.setPixelStub(), this.loadTikTokScript(n.pixelId), e.prototype.initialize.call(this, t)
                        }, t.prototype.setPixelStub = function() {
            ...
            8831: function(e, t, n) {
                ...
                var a = n(372),
                    ...
                    f = function(e) {
                        ...
                        return r(t, e), t.prototype.integrationPurposes = function() {
                            return [d.ConsentPurposes.ANALYTICS]
                        }, t.prototype.consentCollected = function(e) {}, t.prototype.name = function() {
                            return "Trekkie"
                        }, t.prototype.type = function() {
                            return d.IntegrationTypes.INTEGRATION
                        }, t.prototype.init = function(e) {
                            this.defaultAttributes = p.default.attributes, u.cleanupOverScopedCookies(), this.initialized = !0, e()
            ...
            9115: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.TREKKIE_GOOGLE_CONSENT_MODE = void 0;
                var n = new(function() {
                    function e() {
                        this.betaFlagsProps = []
                    }
                ...
                t.TREKKIE_GOOGLE_CONSENT_MODE = "bbcf04e6", t.default = n
            },
            6997: function(e, t, n) {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    ...
                    if (void 0 === o)
                        if (function() {
                            ...
                            for (var t = "", n = 0, r = d.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (y(e, a, 0, t), h(e, a)) return void(o = t)
                            }
                            o = ""
                        }
                }
            ...
            7662: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.saleOfDataAllowed = t.preferencesProcessingAllowed = t.marketingAllowed = t.analyticsProcessingAllowed = t.resetConsentCookieCache = t.haveConsentForIntegrationFromEvent = t.haveConsentForIntegration = t.haveConsentForMarketingOrAnalytics = t.haveConsentForPurpose = t.userDataCannotBeSold = t.isGDPREnforced = t.isCCPAEnforced = t.TrackingEvents = void 0;
                var o = n(1863);
                ...
                function a(e) {
                    return e ? Boolean(e.analyticsAllowed || e.marketingAllowed || e.saleOfDataAllowed) : this.haveConsentForPurpose(r.ConsentPurposes.ANALYTICS) || this.haveConsentForPurpose(r.ConsentPurposes.THIRD_PARTY_MARKETING) || this.haveConsentForPurpose(r.ConsentPurposes.FIRST_PARTY_MARKETING)
                }
                ...
                t.TrackingEvents = o.TrackingEvents, t.isCCPAEnforced = function() {
                    return i()
                }, t.isGDPREnforced = function() {
                    return !(o.marketingAllowed() && o.analyticsProcessingAllowed())
                }, t.userDataCannotBeSold = i, t.haveConsentForPurpose = function(e) {
                    switch (e) {
                        case r.ConsentPurposes.ANALYTICS:
                            return o.analyticsProcessingAllowed();
                        case r.ConsentPurposes.FIRST_PARTY_MARKETING:
                ...
                }, t.haveConsentForMarketingOrAnalytics = a, t.haveConsentForIntegration = function(e) {
                    if ("S2S" === e.name() || "Google Gtag Pixel" === e.name()) return this.haveConsentForMarketingOrAnalytics();
                    ...
                    if ("S2S" === e.name() || "Google Gtag Pixel" === e.name()) return a(t);
            ...
            2971: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "64022fdadec5c8ec4be5f67dbeb0521916405ce3",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                    ...
                    C = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            s.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "64022fdadec5c8ec4be5f67dbeb0521916405ce3",
                                ...
                                try {
                                    if ("https://order.buywithprime.amazon.com/" === e.origin) {
                                        var d = null === (n = null === (t = window.ShopifyAnalytics) || void 0 === t ? void 0 : t.meta) || void 0 === n ? void 0 : n.product,
                                            p = (null === (i = null == d ? void 0 : d.variants) || void 0 === i ? void 0 : i.length) > 0 ? null === (a = null == d ? void 0 : d.variants[0]) || void 0 === a ? void 0 : a.id : void 0,
                            ...
                            return {
                                s2sMetadata: a,
                                eventId: "string" == typeof i && i.length > 0 ? i : p.buildToken()
                            }
                            ...
                            d.haveConsentForIntegration(this.trekkie) || (m.Trekkie = [!1, this.trekkie, []]);
                            for (var i = 0, a = e; i < a.length; i++) {
                                ...
                                try {
                                    ...
                                    if (p && "object" == typeof p) {
                                        ...
                                        var _ = l.type() === f.IntegrationTypes.ECOMMERCE;
                                        d.haveConsentForIntegration(l) ? _ ? l.initialize(r) : r() : (m[u] = [_, l, []], r())
                                    } else r()
                                } catch (e) {
                            ...
                            for (var r = this.generatePageObject(e, t, o.eventId, o.s2sMetadata), i = 0, a = this.integrations; i < a.length; i++) {
                                var s = a[i];
                                try {
                                    if (d.haveConsentForIntegration(s)) s.page(r);
                                    else {
                                        var u = s.name();
                                        if (m[u] && Array.isArray(m[u][2])) {
                                            var p = m[u][2],
                                                l = ["page", r];
                                            p.push(l)
                                        }
                            ...
                            for (var i = {
                                ...
                                }, a = 0, s = this.integrations; a < s.length; a++) {
                                var u = s[a];
                                try {
                                    if (d.haveConsentForIntegration(u)) u.track(i);
                                    else {
                                        var p = u.name();
                                        if (m[p] && Array.isArray(m[p][2])) {
                                            var l = m[p][2],
                                                f = ["track", i];
                                            l.push(f)
                                        }
                            ...
                            this.defList = this.consentCollectedListener.bind(this), document.addEventListener(d.TrackingEvents.CONSENT_COLLECTED, this.defList)
                        }, e.prototype.removeConsentCollectedListener = function() {
                            document.removeEventListener(d.TrackingEvents.CONSENT_COLLECTED, this.defList)
                            ...
                            d.resetConsentCookieCache();
                            var t = e.detail;
                            h.default.refreshVisitorTokens(), this.initializeDeferredIntegrations(t);
                            for (var n = 0, o = this.integrations; n < o.length; n++) {
                                var r = o[n];
                                r.initialized && r.consentCollected(t)
                            }
                            this.flushMonorailEventsIfLoaded()
                        }, e.prototype.initializeDeferredIntegrations = function(e) {
                            for (var t = [], n = 0; n < Object.keys(m).length; n++) {
                                var o = Object.keys(m)[n],
                                    r = m[o],
                                    i = r[0],
                                    a = r[1],
                                    s = r[2];
                                if (d.haveConsentForIntegrationFromEvent(a, e)) {
                                    i && a.initialize((function() {}));
    ...
    n.d = function(e, t) {
        ...
        function() {
            ...
            var d = n(342);
            i.push(["TikTok Pixel", d.TikTok]);
            var p = n(2724);
            i.push(["Session Attribution", p.SessionAttribution]);
            var l = n(5087);
